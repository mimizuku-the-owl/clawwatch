...
function tooltipFormatter(value: number | undefined, name: string | undefined) {
  if (value !== undefined)
    return [formatTokens(value), name === "inputTokens" ? "Input Tokens" : "Output Tokens"];
  return [0, name];
}

export const TokenUsageByModelInternal = memo(function TokenUsageByModelInternal({ data }: Props) {
  return (
